...
def main() -> int:
    ...
    try:
        ...
        assert_true("app.js?v=20260519-50" in page, "首页应引用新的前端资源版本，避免浏览器缓存旧 app.js")
        assert_true("styles.css?v=20260519-50" in page, "首页应引用新的样式资源版本，避免浏览器缓存旧 styles.css")
        ...
        assert_true("min-height: 260px" in styles_css, "首页导航分组面板应有稳定高度，避免外层卡片显得过短")
        assert_true("min-height: 96px" in styles_css, "首页导航卡片高度应与其他页面卡片保持接近，不应显得过短")

...
def main() -> int:
    ...
    try:
        ...
        assert_true("app.js?v=20260518-8" in page, "首页应引用新的前端资源版本，避免浏览器缓存旧 app.js")
        assert_true("styles.css?v=20260518-8" in page, "首页应引用新的样式资源版本，避免浏览器缓存旧 styles.css")
        assert_true("@codemirror/lang-yaml" in page, "首页应加载 CodeMirror YAML 编辑器")

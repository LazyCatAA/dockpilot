...
def main() -> int:
    ...
    try:
        ...
        assert_true("app.js?v=20260518-3" in page, "首页应引用新的前端资源版本，避免浏览器缓存旧 app.js")
        assert_true("styles.css?v=20260518-3" in page, "首页应引用新的样式资源版本，避免浏览器缓存旧 styles.css")
        ...
        assert_true("-webkit-text-fill-color: #d8e6f7" in styles_css, "Compose 编辑器文字应可见")

...
def main() -> int:
    ...
    try:
        ...
        assert_true("app.js?v=20260518-10" in page, "首页应引用新的前端资源版本，避免浏览器缓存旧 app.js")
        assert_true("styles.css?v=20260518-10" in page, "首页应引用新的样式资源版本，避免浏览器缓存旧 styles.css")
        ...
        assert_true(".settings-page" in styles_css, "系统设置页应使用重构后的双栏布局")
